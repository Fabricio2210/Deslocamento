   ...
   <p>Clique no local indicado na figura para baixar a planilha modelo</p>
    ...
    <p>Clique no local indicado na figura para calcular os deslocamentos</p>
     ...
     <p>Após o cálculo a aplicação ficará como na figura</p>
      ...
      <p>Clique nos icones de copiar para copiar as informações ou clique no botão verde para baixar a planilha já com os deslocamentos. Depois clique no botão amarelo para subir um novo arquivo</p>
  </div>
</template>
