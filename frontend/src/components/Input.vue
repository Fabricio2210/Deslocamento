<template>
  <div class="container">
    <notifications
      class="py-1"
      group="sucesso"
      classes="alert alert-success bg-success text-white animated slideInDown faster"
      position="top center"
    />
    <notifications
      class="py-1"
      group="erro"
      classes="alert bg-danger text-white animated slideInDown faster "
      role="alert"
      position="top center"
    />
    <transition leave-active-class="animated fadeOut" mode="out-in">
      <div class="form-group" v-if="isArquivoEnviado">
        <div class="input-group">
          <label>File</label>
          <input
            class="btn btn-secondary custom-file-label py-1"
            type="file"
            id="file"
            ref="file"
    ...
    <a
      class="btn btn-primary btn-lg btn-block"
      href="seubackendaqui/upload.xlsx"
      role="button"
      >Planilha Modelo</a
    >
  </div>
